...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="w-full h-14 z-10 fixed border-b px-8 bg-white bg-opacity-10 backdrop-blur">
      ...
      <div className={`fixed inset-0 bg-black bg-opacity-60 z-10 transition-opacity ${isMobileMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`} onClick={toggleMobileMenu}></div>
